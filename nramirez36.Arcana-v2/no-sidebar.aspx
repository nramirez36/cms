<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="no-sidebar.aspx.cs" Inherits="nramirez36.Arcana_v2.no_sidebar" %>
        ...
        <div id="header">
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li class="current"><a href="no-sidebar.aspx">No Sidebar</a></li>
                </ul>
            </nav>
