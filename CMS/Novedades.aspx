<%@ Page Title="nramirez36 - Novedades" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="Novedades.aspx.cs" Inherits="CMS.Novedades" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="Novedades.aspx" id="logo">nramirez36 - <em>Novedades</em></a></h1>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpContenido" runat="server">
    <div id="content">
        ...
        <article>
            ...
            <asp:Table ID="tableNovedades" runat="server" Style="width: 100%;" Width="100%" CssClass="box box-style1">
            </asp:Table>
