<%@ Page Title="TODO SALUD - Prestaciones" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="Prestaciones.aspx.cs" Inherits="CMS.Prestaciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="index.aspx" id="logo">TODO SALUD - <em>Prestaciones</em></a></h1>
</asp:Content>
