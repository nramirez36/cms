<%@ Page Title="TODO SALUD - Pacientes" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="Pacientes.aspx.cs" Inherits="CMS.Pacientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="index.aspx" id="logo">TODO SALUD - <em>Pacientes</em></a></h1>
</asp:Content>
