<%@ Page Title="nramirez36 - Nosotros" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="Nosotros.aspx.cs" Inherits="CMS.Nosotros" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="Nosotros.aspx" id="logo">nramirez36 - <em>Nosotros</em></a></h1>
</asp:Content>
