<%@ Page Title="nramirez36 - Historia" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="Historia.aspx.cs" Inherits="CMS.Historia" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="index.aspx" id="logo">nramirez36 - <em>Nuestra Historia</em></a></h1>
</asp:Content>
    ...
    <ul>
        ...
        <li class="current">
            ...
            <ul>
                ...
                <li class="current"><a href="Historia.aspx">Nuesta Historia</a></li>
