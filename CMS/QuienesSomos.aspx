<%@ Page Title="TOTAL SALUD - Quienes Somos" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="QuienesSomos.aspx.cs" Inherits="CMS.QuienesSomos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTituloPagina" runat="server">
    <h1><a href="index.aspx" id="logo">TOTAL SALUD - <em>Quienes Somos </em></a></h1>
</asp:Content>
